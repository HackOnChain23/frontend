      ...
      <div class="w-full h-full p-4">
        ...
        <div class="w-full h-[15rem] flex">
          ...
          >
            ...
            <div class="h-auto flex w-full bg-black space-y-4 flex-col">
        ...
        >
          <div
            class="w-7/12 h-full ml-10 flex flex-wrap items-center justify-center"
          >
            <div
          ...
          <div
            class="3/12 p-4 flex flex-col space-y-1 items-center justify-center"
          >
            <button
...
const photos = [
  "assets/ourPhotos/mateusz.jpg",
  "assets/ourPhotos/szacilowski.jpg",
  "assets/ourPhotos/szacilowski.jpg",
  "assets/ourPhotos/mateusz.jpg",
];
