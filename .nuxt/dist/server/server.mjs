import { reactive, hasInjectionContext, getCurrentInstance, effectScope, ref, markRaw, toRaw, inject, watch, unref, isRef, isReactive, toRef, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, version, watchEffect, isShallow, shallowRef, isReadonly, h, defineComponent, Transition, Suspense, provide, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, defineAsyncComponent, createApp } from "vue";
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1.0" }, { "charset": "utf-8" }, { "name": "description", "content": "content" }], "link": [{ "rel": "dns-prefetch", "href": "https://fonts.gstatic.com/" }, { "rel": "preconnect", "href": "https://fonts.gstatic.com/", "crossorigin": "anonymous" }, { "rel": "preconnect", "href": "https://fonts.googleapis.com/" }, { "data-hid": "gf-style", "rel": "stylesheet", "href": "https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap" }], "style": [], "script": [], "noscript": [], "charset": "utf-8", "viewport": "width=device-width, initial-scale=1.0", "title": "PSPLS Test Project" };
...
const revive_payload_server_8su8ZGM2KR = /* @__PURE__ */ defineNuxtPlugin({
...
const unhead_ogutviU3oF = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/choseway-7b1043cb.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-210bf4aa.js").then((m) => m.default || m)
  },
  {
    name: "workspace",
    path: "/workspace",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/workspace-66ee75d1.js").then((m) => m.default || m)
  }
];
...
const plugin_VTZwCAYXZt = /* @__PURE__ */ defineNuxtPlugin(async () => {
  let __temp, __restore;
  const Web3 = ([__temp, __restore] = executeAsync(() => import("web3").then((r) => r.default || r)), __temp = await __temp, __restore(), __temp);
  return {
    provide: {
      Web3
    }
...
const vue3_particles_ehoSkd7w7V = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(Particles);
});
const _plugins = [
  plugin$1,
  revive_payload_server_8su8ZGM2KR,
  components_plugin_KR1HBZs4kY,
  unhead_ogutviU3oF,
  plugin,
  plugin_VTZwCAYXZt,
  vue3_particles_ehoSkd7w7V
];
...
const layouts = {
  default: () => import("./_nuxt/default-2aa734ba.js").then((m) => m.default || m)
};
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.5.1_sass@1.62.1/node_modules/nuxt/dist/pages/runtime/app.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-bfa74c79.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-d5c95736.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.5.1_sass@1.62.1/node_modules/nuxt/dist/app/components/nuxt-root.vue");
